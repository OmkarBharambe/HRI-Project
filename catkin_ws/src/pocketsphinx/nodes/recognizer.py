...
class recognizer(object):
    ...
    def __init__(self):
        ...
        self._device_name_param = "audio-input-microphone"  # Find the name of your microphone by typing pacmd list-sources in the terminal
        self._lm_param = "~lm"
        ...
        self.launch_config += "!autoaudiosink ! audioconvert ! audioresample " \
