...
class ASRControl(object):
    ...
    def __init__(self, model, lexicon, kwlist, pub):
        ...
        #self.decoder.set_kws('keyword', kwlist)
    ...
    def parse_asr_result(self):
        ...
        """
        #print("staring parse_asr_result")
            ...
            for seg in self.decoder.seg():
                ...
                if seg.word.find("half speed") > -1:
                    if self.speed == 0.4:
                        ...
                        self.msg.angular.z = self.msg.angular.z/2
                        self.speed = 0.2
                if seg.word.find("forward") > -1 or seg.word.find("move") > -1:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,
        default='/usr/local/lib/python3.6/dist-packages/pocketsphinx/model/en-us/en-us',
